      ...
      <div class="col-md-8">
        <div class="card shadow">
          <div class="card-header">
            <h3 class="card-title px-2 py-3">Information Systems Case Study Club Member Registration Form</h3>
          ...
          <div class="card-body px-4 py-3">
            <form>
              ...
              <div class="mb-3">
                ...
                <input type="text" class="form-control" id="role" value="IS Case Study Club Member" readonly>
              </div>
              <div class="mb-3">
