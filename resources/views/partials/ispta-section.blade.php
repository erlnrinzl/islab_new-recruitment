<div class="row" id="section-1">
    <div class="shadow col-md-6 ps-0" id="hero">
        <div id="carouselFadeispta" class="carousel carousel-fade" data-bs-ride="carousel">
            ...
            <button class="carousel-control-prev" type="button" data-bs-target="#carouselFadeispta" data-bs-slide="prev">
              <span class="carousel-control-prev-icon" aria-hidden="true"></span>
              <span class="visually-hidden">Previous</span>
            </button>
            <button class="carousel-control-next" type="button" data-bs-target="#carouselFadeispta" data-bs-slide="next">
