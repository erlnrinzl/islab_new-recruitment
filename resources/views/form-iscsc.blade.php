            ...
            <div class="col-md-8">
                <div class="card shadow">
                    <div class="card-header">
                        <h3 class="card-title px-2 py-3">Information Systems Case Study Club Member Registration Form
                        </h3>
                        ...
                        <form>
                            ...
                            <div class="mb-3">
                                ...
                                <input type="email" class="form-control" id="email"
                                    value="brayen.cahyadi@binus.ac.id" readonly>
                            </div>
                            <div class="mb-3">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" id="period"
                                    value="2023/2024 Even Semester" readonly>
                            </div>
                            <div class="mb-3">
                                <label for="role" class="form-label">Role:</label>
                                <input type="text" class="form-control" id="role"
                                    value="IS Case Study Club Member" readonly>
                            </div>
                            <div class="mb-3">
